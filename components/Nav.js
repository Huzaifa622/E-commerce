...
const Nav = () => {
  ...
  const mobileActive = "top-14 transition-all ease-in"
  const mobileInActive = "top-[-400] transition-all ease-in"
 ...
 : <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12" />
      ...
      <div className={nav?'bg-white absolute opacity-100 text-violet-600 left-0 top-14 transition-all ease-in  w-full flex flex-col justify-center items-center duration-500 md:hidden ':'bg-white absolute opacity-100 transition-all ease-in duration-500 text-violet-600 left-0 top-[-400px]  w-full flex flex-col justify-center items-center md:hidden'}>
        ...
        <Link className="py-4" href={"/categories"}>
          <div className="flex">
            <svg
        ...
        <Link className="py-4" href={"/orders"}>
          <div className="flex">
            <svg
        ...
        <Link className="py-4" href={"/settings"}>
          <div className="flex">
            <svg
      ...
      <div className=" hidden md:flex">
        ...
        <Link
          className={router.pathname.includes("/products") ? active : inactive}
          href={"/products"}
        >
          <svg
            data-tooltip-id="products"
        ...
        <Link
          className={
            router.pathname.includes("/categories") ? active : inactive
          }
          href={"/categories"}
        >
          <svg
        ...
        <Link
          className={router.pathname.includes("/orders") ? active : inactive}
          href={"/orders"}
        >
          <svg
            data-tooltip-id="orders"
      ...
      <Tooltip id="dashboard" place="bottom" content="Dashboard" />
